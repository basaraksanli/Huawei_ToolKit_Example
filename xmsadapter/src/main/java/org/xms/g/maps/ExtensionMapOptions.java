...
/**
 * xms Defines configuration MapOptions for a Map.<br/>
...
public final class ExtensionMapOptions extends org.xms.g.utils.XObject {
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.maps.HuaweiMapOptions.createFromAttributes(android.content.Context,android.content.Context,android.util.AttributeSet): <a href="https://developer.huawei.com/consumer/en/doc/development/HMS-References/hms-map-huaweimapoptions#createFromAttributes(Context,AttributeSet)">https://developer.huawei.com/consumer/en/doc/development/HMS-References/hms-map-huaweimapoptions#createFromAttributes(Context,AttributeSet)</a><br/>
     * com.google.android.gms.maps.GoogleMapOptions.createFromAttributes.createFromAttributes(android.content.Context,android.util.AttributeSet): <a href="https://developers.google.com/android/reference/com/google/android/gms/maps/GoogleMapOptions#public-static-googlemapoptions-createfromattributes-context-context,-attributeset-attrs">https://developers.google.com/android/reference/com/google/android/gms/maps/GoogleMapOptions#public-static-googlemapoptions-createfromattributes-context-context,-attributeset-attrs</a><br/>
     *
